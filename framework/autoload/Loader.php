    ...
    class Lazy_Loader
    {
        ...
        protected static function register()
        {
            if (!self::$registered) {
                ...
                spl_autoload_register('Lazy_Loader::load');
        ...
        static function load($class)
        {
            ...
            if(count($classArray) === 1) {
                ...
                $className = $classArray[count($classArray) - 1].'.php';
                $fileName = str_replace(strtolower($className), $className, strtolower($class).'.php');
                $file = str_replace('_', DIRECTORY_SEPARATOR, $fileName);
            }
        ...
        protected static function updateMap($class, $origin)
        {
            if (is_writable(self::$mapfile)
                ...
                file_put_contents(
                    self::$mapfile, 
                    '<'."?php\n"
                    . "// Lazy_Loader auto-generated classmap\n"
